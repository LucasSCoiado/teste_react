function Navbar() {
  ...
  return (
    <section className="px-4 py-10 bg-slate-900">
      <div className="max-w-6xl mx-auto flex flex-col items-center">
        <h2 className="text-slate-200 text-3xl sm:text-4xl font-semibold mb-8 text-center">
          Seja bem-vindo
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 w-full">
          {sections.map((item) => (
            <div
              ...
              className="min-h-24 bg-slate-700 rounded-2xl flex items-center justify-center shadow-lg hover:bg-slate-600 transition cursor-pointer p-4 hover:animate-bounce"
            >
        ...
        <div className="bg-slate-500 my-4 text-slate-50 text-base rounded-md">
          <h3 id="cliente" className="text-end text-2xl m-2">
            Clientes
          </h3>
          <div className="flex gap-4 p-2 items-center">
            ...
            <img
              ...
              alt="Clientes"
              className="w-[15em] h-[12em] flex-shrink-0 rounded-md"
            />
          </div>
          ...
          <h3 id="fornecedor" className="text-start text-2xl m-2">
            Fornecedor
          </h3>
          <div className="flex gap-4 p-2 items-center">
            <img
          ...
          <h3 id="funcionario" className="text-end text-2xl m-2">
            Funcionários
          </h3>
          <div className="flex gap-4 p-2 items-center">
            <p className="flex-1">
          ...
          <h3 id="pedido" className="text-start text-2xl m-2">
            Pedidos
          </h3>
          <div className="flex gap-4 p-2 items-center">
            <img
          ...
          <h3 id="produto" className="text-end text-2xl m-2">
            Produtos
          </h3>
          <div className="flex gap-4 p-2 items-center">
            <p className="flex-1">
